package com.skywomantech.cloud.symptommanagement.json;
 ...
 * Video objects, this ObjectMapper overrides the default JSON marshaling of Spring Data Rest so
...
public class ResourcesMapper extends ObjectMapper {
	...
	private JsonSerializer<Resources> serializer = new JsonSerializer<Resources>() {
		...
		public void serialize(Resources value, JsonGenerator jgen,
			...
			// Just marshal the actual content (Videos) into the JSON
